...
// Function to send attendance data to backend using axios
// Arranged to match the POST request as shown in Postman (JSON body, not 'body' property)
...
const ScanQr = () => {
  ...
  return (
    ...
    //       {/* QR Scanner Section */}
    //       <div className="w-full bg-white rounded-lg shadow-md p-0 flex flex-col items-center">
    //         <div className="relative w-full h-[60vh] bg-gray-200 flex items-center justify-center rounded-b mb-4 overflow-hidden">
    //           <div
    //             id={qrRegionId}
    ...
    //           />
    //           {!scanning && (
    //             <div className="absolute inset-0 flex items-center justify-center text-gray-400 text-center bg-gray-100 bg-opacity-80 z-10">
    //               <span>Camera preview will appear here</span>
    //             </div>
    //           )}
    //         </div>
    //         {scanResult && (
    //           <div className="mb-2 text-green-600 font-semibold text-center">
    //             {scanResult}
    //           </div>
    //         )}
    //         {error && (
    ...
    //         <label className="block text-gray-700 mb-2" htmlFor="manual-qr">
    ...
    //       {locationError && (
    //         <div className="mt-2 text-red-500 text-center">{locationError}</div>
    //       )}
    //     </div>
    //   </div>
    // </div>
